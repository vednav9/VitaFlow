...
const BubblePopGame = ({ onExit }) => {
  ...
  useEffect(() => {
    ...
    const spawner = setInterval(() => {
      ...
      const color = ['bg-cyan-500', 'bg-purple-500', 'bg-pink-500'][Math.floor(Math.random() * 3)];
        ...
        {gameOver && (
          <div className="absolute inset-0 flex items-center justify-center bg-black/60 backdrop-blur-sm z-50">
            ...
            >
              ...
              <p className="text-xl text-gray-300 mb-8">You popped enough bubbles to reduce simulated stress by 20%.</p>
              <div className="text-6xl font-bold text-cyan-400 mb-8">{score}</div>
  ...
  return (
    <div className="fixed inset-0 bg-black/90 z-50 flex flex-col items-center justify-center p-8 backdrop-blur-xl">
      ...
      <div className="relative text-center">
        ...
        <p className="text-gray-400 mb-12">Tap the circle when it matches the outer ring</p>

        <div className="relative w-80 h-80 mx-auto flex items-center justify-center cursor-pointer" onClick={handleTap}>
          {/* Target Ring */}
    ...
    <div className="flex h-screen bg-black overflow-hidden relative">
      ...
      <main className="flex-1 ml-64 p-12 overflow-y-auto">
        <header className="mb-12">
          <h1 className="text-4xl font-bold text-white mb-2">Stress Relief Games</h1>
          <p className="text-gray-400">Take a break and clear your mind with these interactive experiences.</p>
        </header>
