    ...
    <PageTransition>
      <div className="relative h-screen flex flex-col items-center justify-center overflow-hidden bg-black selection:bg-purple-500/30">
        ...
        <div className="z-10 text-center space-y-8 p-4 relative">
          ...
          >
            <div className="absolute -inset-8 blur-3xl bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 opacity-20 rounded-full"></div>
            <h1 className="text-7xl md:text-9xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-cyan-300 via-purple-300 to-pink-300 drop-shadow-2xl relative z-10 tracking-tighter">
              VitaFlow OS
            </h1>
          </motion.div>
