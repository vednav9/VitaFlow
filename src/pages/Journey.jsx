  ...
  return (
    <div className="relative flex flex-col items-center mb-16 w-full group">
      ...
      >
        ...
        {/* Floating Label */}
        <div
          className={`absolute ${index % 2 === 0 ? "left-28" : "right-28"} w-48 p-4 glass-card backdrop-blur-md transition-transform group-hover:scale-105 border-l-4 ${completed ? "border-l-cyan-400" : "border-l-gray-600"}`}
        >
          <h3
            className={`font-bold ${completed ? "text-white" : "text-gray-500"}`}
          >
            {label}
          </h3>
