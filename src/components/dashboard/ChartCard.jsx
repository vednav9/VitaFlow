...
export const ChartCard = ({ title, children, delay }) => (
  ...
  >
    <div className="flex justify-between items-center mb-6">
      <h3 className="text-xl font-medium text-gray-200 tracking-wide bg-clip-text bg-gradient-to-r from-gray-100 to-gray-400">
        {title}
      </h3>
    ...
    <div className="flex-1 w-full relative z-10 text-xs">{children}</div>
  </motion.div>
);
