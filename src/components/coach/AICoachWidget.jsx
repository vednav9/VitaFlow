...
export const AICoachWidget = () => {
  ...
  const [messages, setMessages] = useState([
    {
      role: "ai",
      text: "Hello! I am Vita, your personal wellness AI. How can I help you today?",
    },
  ]);
              ...
              <div className="flex items-center gap-3 relative z-10">
                ...
                <div>
                  <h3 className="font-bold text-white flex items-center gap-2">
                    VitaCoach AI
                    <span className="px-2 py-0.5 rounded-full bg-green-500/20 text-green-400 text-[10px] font-bold uppercase border border-green-500/30">
                      Online
                    </span>
                  </h3>
                  <p className="text-xs text-cyan-200/70">
                    Powered by VitaFlow OS
                  </p>
                </div>
              </div>
              <button
            ...
            >
              {messages.map((msg, i) => (
                ...
                >
                  ...
                  >
                    <div
                      className={`w-8 h-8 rounded-full flex-shrink-0 flex items-center justify-center ${msg.role === "user" ? "bg-indigo-600" : "bg-cyan-600"}`}
                    >
                      {msg.role === "user" ? (
                        <User size={14} />
                      ) : (
